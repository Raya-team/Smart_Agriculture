...
$(document).ready(function () {
  ...
  $('#btnAdd').click(function () {
    ...
    var fnCell = $('<td class="del1"><div  style="background-color:' + x + ';width: 18px;height: 18px; border-radius: 100%; margin-top: 2px"></div></td>'); // var opCell = $('<td><i class="fa fa-fw fa-trash del"></i></td>');
