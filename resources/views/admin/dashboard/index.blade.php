        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3>{{$total_area}}</h3>
                        <p style="font-size:18px">مساحت کل (هکتار)</p>
                    </div>
                    <div class="icon" style="padding-top: 12px">
                        <i class="fa fa-fw fa-area-chart"></i>
                    </div>
                    <span class="small-box-footer bg-green" style="height: 20px"></span>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6" style="height:180px">
                <!-- small box -->
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <div class="icon" style="padding-top: 12px; margin-left: -20px">
